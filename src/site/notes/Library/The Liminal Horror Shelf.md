---
{"dg-publish":true,"permalink":"/library/the-liminal-horror-shelf/"}
---


### **Liminal Horror** (2021)
![book_liminalhorror.png\|left hsmall](/img/user/Images/Books/book_liminalhorror.png)
**Author:**  Goblin Archives
**Pages**:  44
**Description**: An OSR-inspired **system** of survival horror that pits mundane Investigators against unnatural horrors that will change them irreversibly.
...
![book_liminalhorror_themall.png\|left hsmall](/img/user/Images/Books/book_liminalhorror_themall.png)
**Author:** Goblin Archives
**Pages**: 40
**Description**: A **module** set in a 1999 shopping mall, in which the clerks and shoppers become trapped, leading them to break into factions as something unnatural, and horrifying, preys on them.
